...
- (id) init
{
	...
	if (self)
	{
        ...
        NSString *text;
        if(_type==GAME_TIP){
            text = @"Game Description: Drag the entire row, column, or swap pairs fruit to create the line of the three identical fruits to eliminate, you can also use help tools , play to the characteristics of different tools to help you get a high score, I wish you a pleasant game ~";
        }else{
            text = @"Game description: Money mode, swinging the phone or drag turtle catch falling fruit to get score , I wish you a pleasant game ~";
        }
        ...
        label.position = ccp(size.width/2, size.height/2-(isPad?10:20)-iPhone5offsetHalf);
        [self addChild:label];
